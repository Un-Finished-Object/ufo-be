...
class AlternativeControllerTest {
    ...
    void createComment_ReturnsServiceResponse() {
        ...
        AlternativeCommentCreateResponse item = new AlternativeCommentCreateResponse(7L, "hello", "tester", LocalDateTime.now());
        ...
        assertThat(response.getBody()).isNotNull();
        assertThat(response.getBody().data().altId()).isEqualTo(7L);
