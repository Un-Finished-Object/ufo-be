...
public class AttendanceController {
    ...
    @GetMapping("/status")
    public ResponseEntity<ApiResponse<AttendanceStatusResponse>> getStatus(@LoginUser User user) {
        return ResponseEntity.ok(ApiResponse.success(attendanceService.getStatus(user)));
    }
}
